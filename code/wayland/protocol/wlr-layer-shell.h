 ...
 * environment.
 *
 * Layer surface states (layer, size, anchor, exclusive zone,
 ...
 * returns to the states it had right after layer_shell.get_layer_surface.
...
enum zwlr_layer_surface_v1_error {
	/**
	 * provided surface states is invalid
	 */
